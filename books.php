                            ...
                            success: function(response) {
                                ...
                                if (response.books.length < 1) {
                                    bookContainer = `
                                        <div class="col-12 pb-1">
                                            <div class="product-item bg-light mb-4">
                                                <h3 class="text-center text-danger py-3">ไม่พบหนังสือ</h3>
                                            </div>
                                        </div>
                            `;
                                } else {
                    ...
                    function loadBookAll(page = 1, limit = 9, search = '') {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                // ถ้าไม่มีข้อมูลหนังสือให้แสดงข้อความ "ไม่พบหนังสือ"
                                if (response.books.length === 0) {
                                    bookContainer = `
                                        <div class="col-lg-12 col-md-12 col-sm-12 pb-1">
                                            <div class="product-item bg-light mb-4">
                                                <h3 class="text-center text-danger py-3">ไม่พบข้อมูลหนังสือ</h3>
                                            </div>
                                        </div>
                        `;
                                } else {
